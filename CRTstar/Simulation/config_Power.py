...
c = 0.3                                # Conditional independence of internal Y and X given z (confounding level)
cE = 0.3                               # Conditional independence of external YE and XE given zE (confounding level)
